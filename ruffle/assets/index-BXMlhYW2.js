const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ruffle_web-Dv4loSnS.js","./ruffle-imports-CztXuSei.js","./ruffle_web-wasm_mvp-BYB4AH0t.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var vm;function eg(){if(vm)return K;vm=1;var s=Symbol.for("react.transitional.element"),i=Symbol.for("react.portal"),u=Symbol.for("react.fragment"),o=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),m=Symbol.for("react.consumer"),h=Symbol.for("react.context"),k=Symbol.for("react.forward_ref"),w=Symbol.for("react.suspense"),b=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),L=Symbol.iterator;function Q(v){return v===null||typeof v!="object"?null:(v=L&&v[L]||v["@@iterator"],typeof v=="function"?v:null)}var V={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},ae=Object.assign,oe={};function ge(v,O,G){this.props=v,this.context=O,this.refs=oe,this.updater=G||V}ge.prototype.isReactComponent={},ge.prototype.setState=function(v,O){if(typeof v!="object"&&typeof v!="function"&&v!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,v,O,"setState")},ge.prototype.forceUpdate=function(v){this.updater.enqueueForceUpdate(this,v,"forceUpdate")};function Ye(){}Ye.prototype=ge.prototype;function xe(v,O,G){this.props=v,this.context=O,this.refs=oe,this.updater=G||V}var be=xe.prototype=new Ye;be.constructor=xe,ae(be,ge.prototype),be.isPureReactComponent=!0;var ie=Array.isArray,X={H:null,A:null,T:null,S:null},Me=Object.prototype.hasOwnProperty;function Ee(v,O,G,F,U,re){return G=re.ref,{$$typeof:s,type:v,key:O,ref:G!==void 0?G:null,props:re}}function Ae(v,O){return Ee(v.type,O,void 0,void 0,void 0,v.props)}function x(v){return typeof v=="object"&&v!==null&&v.$$typeof===s}function M(v){var O={"=":"=0",":":"=2"};return"$"+v.replace(/[=:]/g,function(G){return O[G]})}var ee=/\/+/g;function Je(v,O){return typeof v=="object"&&v!==null&&v.key!=null?M(""+v.key):O.toString(36)}function tn(){}function Ne(v){switch(v.status){case"fulfilled":return v.value;case"rejected":throw v.reason;default:switch(typeof v.status=="string"?v.then(tn,tn):(v.status="pending",v.then(function(O){v.status==="pending"&&(v.status="fulfilled",v.value=O)},function(O){v.status==="pending"&&(v.status="rejected",v.reason=O)})),v.status){case"fulfilled":return v.value;case"rejected":throw v.reason}}throw v}function cn(v,O,G,F,U){var re=typeof v;(re==="undefined"||re==="boolean")&&(v=null);var J=!1;if(v===null)J=!0;else switch(re){case"bigint":case"string":case"number":J=!0;break;case"object":switch(v.$$typeof){case s:case i:J=!0;break;case _:return J=v._init,cn(J(v._payload),O,G,F,U)}}if(J)return U=U(v),J=F===""?"."+Je(v,0):F,ie(U)?(G="",J!=null&&(G=J.replace(ee,"$&/")+"/"),cn(U,O,G,"",function(Le){return Le})):U!=null&&(x(U)&&(U=Ae(U,G+(U.key==null||v&&v.key===U.key?"":(""+U.key).replace(ee,"$&/")+"/")+J)),O.push(U)),1;J=0;var un=F===""?".":F+":";if(ie(v))for(var fe=0;fe<v.length;fe++)F=v[fe],re=un+Je(F,fe),J+=cn(F,O,G,re,U);else if(fe=Q(v),typeof fe=="function")for(v=fe.call(v),fe=0;!(F=v.next()).done;)F=F.value,re=un+Je(F,fe++),J+=cn(F,O,G,re,U);else if(re==="object"){if(typeof v.then=="function")return cn(Ne(v),O,G,F,U);throw O=String(v),Error("Objects are not valid as a React child (found: "+(O==="[object Object]"?"object with keys {"+Object.keys(v).join(", ")+"}":O)+"). If you meant to render a collection of children, use an array instead.")}return J}function C(v,O,G){if(v==null)return v;var F=[],U=0;return cn(v,F,"","",function(re){return O.call(G,re,U++)}),F}function W(v){if(v._status===-1){var O=v._result;O=O(),O.then(function(G){(v._status===0||v._status===-1)&&(v._status=1,v._result=G)},function(G){(v._status===0||v._status===-1)&&(v._status=2,v._result=G)}),v._status===-1&&(v._status=0,v._result=O)}if(v._status===1)return v._result.default;throw v._result}var $=typeof reportError=="function"?reportError:function(v){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var O=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof v=="object"&&v!==null&&typeof v.message=="string"?String(v.message):String(v),error:v});if(!window.dispatchEvent(O))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",v);return}console.error(v)};function we(){}return K.Children={map:C,forEach:function(v,O,G){C(v,function(){O.apply(this,arguments)},G)},count:function(v){var O=0;return C(v,function(){O++}),O},toArray:function(v){return C(v,function(O){return O})||[]},only:function(v){if(!x(v))throw Error("React.Children.only expected to receive a single React element child.");return v}},K.Component=ge,K.Fragment=u,K.Profiler=f,K.PureComponent=xe,K.StrictMode=o,K.Suspense=w,K.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=X,K.act=function(){throw Error("act(...) is not supported in production builds of React.")},K.cache=function(v){return function(){return v.apply(null,arguments)}},K.cloneElement=function(v,O,G){if(v==null)throw Error("The argument must be a React element, but you passed "+v+".");var F=ae({},v.props),U=v.key,re=void 0;if(O!=null)for(J in O.ref!==void 0&&(re=void 0),O.key!==void 0&&(U=""+O.key),O)!Me.call(O,J)||J==="key"||J==="__self"||J==="__source"||J==="ref"&&O.ref===void 0||(F[J]=O[J]);var J=arguments.length-2;if(J===1)F.children=G;else if(1<J){for(var un=Array(J),fe=0;fe<J;fe++)un[fe]=arguments[fe+2];F.children=un}return Ee(v.type,U,void 0,void 0,re,F)},K.createContext=function(v){return v={$$typeof:h,_currentValue:v,_currentValue2:v,_threadCount:0,Provider:null,Consumer:null},v.Provider=v,v.Consumer={$$typeof:m,_context:v},v},K.createElement=function(v,O,G){var F,U={},re=null;if(O!=null)for(F in O.key!==void 0&&(re=""+O.key),O)Me.call(O,F)&&F!=="key"&&F!=="__self"&&F!=="__source"&&(U[F]=O[F]);var J=arguments.length-2;if(J===1)U.children=G;else if(1<J){for(var un=Array(J),fe=0;fe<J;fe++)un[fe]=arguments[fe+2];U.children=un}if(v&&v.defaultProps)for(F in J=v.defaultProps,J)U[F]===void 0&&(U[F]=J[F]);return Ee(v,re,void 0,void 0,null,U)},K.createRef=function(){return{current:null}},K.forwardRef=function(v){return{$$typeof:k,render:v}},K.isValidElement=x,K.lazy=function(v){return{$$typeof:_,_payload:{_status:-1,_result:v},_init:W}},K.memo=function(v,O){return{$$typeof:b,type:v,compare:O===void 0?null:O}},K.startTransition=function(v){var O=X.T,G={};X.T=G;try{var F=v(),U=X.S;U!==null&&U(G,F),typeof F=="object"&&F!==null&&typeof F.then=="function"&&F.then(we,$)}catch(re){$(re)}finally{X.T=O}},K.unstable_useCacheRefresh=function(){return X.H.useCacheRefresh()},K.use=function(v){return X.H.use(v)},K.useActionState=function(v,O,G){return X.H.useActionState(v,O,G)},K.useCallback=function(v,O){return X.H.useCallback(v,O)},K.useContext=function(v){return X.H.useContext(v)},K.useDebugValue=function(){},K.useDeferredValue=function(v,O){return X.H.useDeferredValue(v,O)},K.useEffect=function(v,O){return X.H.useEffect(v,O)},K.useId=function(){return X.H.useId()},K.useImperativeHandle=function(v,O,G){return X.H.useImperativeHandle(v,O,G)},K.useInsertionEffect=function(v,O){return X.H.useInsertionEffect(v,O)},K.useLayoutEffect=function(v,O){return X.H.useLayoutEffect(v,O)},K.useMemo=function(v,O){return X.H.useMemo(v,O)},K.useOptimistic=function(v,O){return X.H.useOptimistic(v,O)},K.useReducer=function(v,O,G){return X.H.useReducer(v,O,G)},K.useRef=function(v){return X.H.useRef(v)},K.useState=function(v){return X.H.useState(v)},K.useSyncExternalStore=function(v,O,G){return X.H.useSyncExternalStore(v,O,G)},K.useTransition=function(){return X.H.useTransition()},K.version="19.0.0",K}var gm;function zs(){return gm||(gm=1,Go.exports=eg()),Go.exports}var nn=zs();const fs=cp(nn);var $o={exports:{}},Wl={},Zo={exports:{}},Qo={};/**
 * @license React
